...
const Login = () => {
    ...
    return (
        <div className='height'>
            <div className='d-flex justify-content-center items-center  p-5 mt-5 my-class shadow-lg'>
                <div className='register'>
                    <form onSubmit={handleLoginFrom}>
                        ...
                        <input className='d-block p-2 w-100 mb-3 mt-2' type="email" name="email" id="" placeholder='Your email' required />
                        <label className='fs-3 mt-3' htmlFor="password">Password</label>
